...
export const REGULATIONS = [
  ...
  {
    title:
      'Regulamin korzystania z voucherów na darmowe godziny gry w Ragnarok',
    sections: [
      {
        title: '§1 Postanowienia ogólne',
        content: [
  ...
  {
    title: "Regulamin Oferty 'Złoty Bilet do Valhalli'",
    sections: [
      {
        title: '§1 Postanowienia ogólne',
        content: [
          "Regulamin określa zasady korzystania z oferty 'Złoty Bilet do Valhalli' w lokalu 'Ragnarok'.",
          "Zakup Biletu oznacza akceptację niniejszego regulaminu oraz Regulaminu Lokalu 'Ragnarok'.",
          'Promocje, rabaty i zniżki związane z Biletem nie łączą się z innymi promocjami, voucherami ani programami lojalnościowymi.',
        ],
      },
      {
        title: '§2 Zasady korzystania z Biletu',
        content: [
          "Bilet umożliwia korzystanie z salek RPG w lokalu 'Ragnarok' w okresie od 1 do 31 lipca 2025 r. w godzinach otwarcia lokalu (12:00–23:00), w miarę dostępności salek.",
          'Bilet przysługuje jednej osobie (posiadaczowi) i umożliwia grę w salce RPG dla grupy maksymalnie 6 osób (posiadacz + do 5 osób towarzyszących).',
          'Posiadacz Biletu może mieć tylko jedną aktywną rezerwację na raz. Kolejna rezerwacja może zostać złożona dopiero po zakończeniu poprzedniej sesji.',
          'Bilet nie gwarantuje dostępności salki w dowolnym terminie. Obowiązuje kolejność zgłoszeń i dostępność salek.',
          'Nie ma możliwości rezerwacji kilku salek jednocześnie ani rozdzielania grupy na więcej niż jedną salkę.',
        ],
      },
      {
        title: '§3 Ograniczenia i wyjątki',
        content: [
          'Rezerwacje z wykorzystaniem Biletu nie mogą kolidować z wydarzeniami organizowanymi przez Ragnarok ani przez partnerów zewnętrznych. Sesje muszą zakończyć się najpóźniej z chwilą rozpoczęcia wydarzenia lub rozpocząć się dopiero po jego zakończeniu.',
          'W przypadku braku dostępności salek z powodu wydarzeń lub innych rezerwacji, Ragnarok nie ponosi odpowiedzialności za brak możliwości wykorzystania Biletu.',
          "Udział w wydarzeniach specjalnych, takich jak 'Chaotyczne Czwartki', podlega ograniczeniom liczby miejsc. Posiadanie Biletu nie gwarantuje udziału – obowiązuje zasada 'kto pierwszy, ten lepszy'.",
          'W przypadku chęci przedłużenia sesji poza godziny otwarcia lokalu, obowiązują standardowe stawki według cennika z uwzględnieniem przysługującej zniżki Biletowej (–3,5 zł/h/osoba).',
        ],
      },
      {
        title: '§4 Korzyści i ważność rabatów',
        content: [
          'Bilet uprawnia do 10% rabatu na zakupy w sklepie stacjonarnym Ragnarok do końca 2025 roku.',
          'Posiadacz Biletu oraz osoby towarzyszące mogą korzystać z: zniżki 3,5 zł/h na wynajem salek RPG, darmowego udziału w RPGowych Telerankach, oraz zniżki 10 zł na Chaotyczne Czwartki – aż do końca 2025 roku.',
          'Udział w innych wydarzeniach może wiązać się z dodatkowymi zniżkami – ogłaszanymi indywidualnie.',
        ],
      },
      {
        title: '§5 Nadużycia i odpowiedzialność',
        content: [
          'W przypadku stwierdzenia prób obchodzenia zasad regulaminu, w tym tworzenia wielu kont lub sztucznego dzielenia grup w celu obejścia limitów, Ragnarok zastrzega sobie prawo do cofnięcia dostępu do Biletu bez zwrotu środków.',
          'Ragnarok zastrzega sobie prawo do weryfikacji, czy korzystanie z Biletu odbywa się zgodnie z jego przeznaczeniem i regulaminem.',
          'Wszelkie sytuacje sporne rozstrzyga obsługa lokalu, której decyzje są ostateczne.',
        ],
      },
      {
        title: '§6 Zakres świadczenia i ograniczenie odpowiedzialności',
        content: [
          "Zakup 'Złotego Biletu do Valhalli' uprawnia wyłącznie do korzystania z salek RPG w lipcu 2025 roku, zgodnie z zasadami określonymi w niniejszym Regulaminie.",
          "Wszelkie dodatkowe benefity, zniżki i udogodnienia przewidziane po lipcu 2025 roku stanowią dobrowolny bonus ze strony organizatora, którego dostępność uzależniona jest od dalszego funkcjonowania lokalu 'Ragnarok' oraz możliwości organizacyjnych.",
          'Organizator zastrzega sobie prawo do ograniczenia lub całkowitego zawieszenia dodatkowych benefitów w dowolnym momencie, w szczególności w przypadku zaprzestania działalności lokalu.',
          'Niewykorzystanie benefitów dodatkowych nie stanowi podstawy do jakichkolwiek roszczeń finansowych wobec organizatora, w tym żądań zwrotu części ceny Biletu.',
        ],
      },
      {
        title: '§7 Postanowienia końcowe',
        content: [
          'Niniejszy Regulamin obowiązuje od dnia jego opublikowania na stronie internetowej Ragnarok oraz w siedzibie lokalu.',
          'Ragnarok zastrzega sobie prawo do zmiany regulaminu. Zmiany będą ogłaszane z co najmniej 7-dniowym wyprzedzeniem.',
          "W sprawach nieuregulowanych niniejszym dokumentem obowiązuje Regulamin Lokalu 'Ragnarok'.",
        ],
      },
    ],
  },
